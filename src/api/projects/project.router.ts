...
projectRouter.put("/:projectId", authenticateJWT, ProjectController.updateProject);
// projectRouter.put("/:projectId", authenticateJWT, ProjectController.updateProject);
// projectRouter.("/:projectId/archive", authenticateJWT, ProjectController.archiveProject);
